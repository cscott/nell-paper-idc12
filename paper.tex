...
will continue to grow, with an increasing number of topics and
customizations.  There are no
ceilings barring a child from participating: Nell
contains a story editor and everything necessary to
author and publish story modules.

To further promote collaboration
Nell is implemented in standard Web technologies (HTML5,
WebGL, and JavaScript) with offline caching.
...
the Nell system.  URL-based naming allows third parties
to manage their own namespaces when extending Nell.

Finally, Nell is designed to allow a capable child to learn
