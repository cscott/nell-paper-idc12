...
% 1st. author
\alignauthor
C. Scott Ananian \qquad Chris Ball \qquad Michael Stone\titlenote{%
...
the turtle is also used to write all the software and stories running inside
her special book.  Rahel begins to write new stories with her own
music and dialog, which make the green book even more
...
story model with programmable conflict resolution. (Figure~\ref{fig:rules} shows
...
based on child preferences or curriculum (for example, the system
could attempt to learn a child's preference for verbal vs. visual
learning), or (during development) flag an error to highlight an
